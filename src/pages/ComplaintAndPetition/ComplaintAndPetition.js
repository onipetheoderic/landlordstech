...
const ComplaintAndPetition = props => {
...
return (
    ...
    <div className="form">
        ...
        <p className="big__header--text">Complaints and Petition</p>
        ...
        <div style={{textAlign:'center'}}>
            <button className="left__button">Make Complaint</button>             
            <button className="right__button">Schedule A Meeting</button> 
        </div>
...
export default ComplaintAndPetition;
